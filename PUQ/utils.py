...
def save_output(desing_obj, name, al_func, nworker, minibatch, seedno, path=None):
    ...
    if path is None:
        ...
        design_path = path + name + '_' + al_func + '_w_' + str(nworker) + '_b_' + str(minibatch) + '_seed_' + str(seedno) + '.pkl'
