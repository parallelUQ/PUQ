...
def runfunction(x, param, truelims, point=True):
    ...
    args.t = "tiers5_opt_Final.json"
    args.train_reps = 1 
    args.test_reps = 1 
    args.f_config = "austin_test_IHT.json"
    args.n_proc = 1 
    args.gt = "[-1,0,5,20,50]"
    args.tr= "transmission_Final_lsq.csv"
    args.hos = 'austin_real_hosp_lsq.csv'
    ...
    if point:
        return daily_ad_benchmark[int(x*221)]
    else:
        return hosp_ad, daily_ad_benchmark
