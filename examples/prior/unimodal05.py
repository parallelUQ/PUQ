...
# 4=(5-3)/0.5, -10=(-2-3)/0.5
    
prior_func      = prior_dist(dist='truncnorm')(a=[-10, -10], b=[4, 4], loc=[3, 3], scale=[0.5, 0.5])
...
if show:
    ...
    fig, ax = plt.subplots()  
    levels = np.array([0.0001, 0.0005, 0.001, 0.003, 0.005, 0.008])
    ...
    #ax.clabel(cp2, fontsize=10, inline=1, manual=[(4, 2)])
