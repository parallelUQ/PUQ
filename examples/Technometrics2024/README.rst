...
Once completed, ``Figure6_banana.png`` is saved under the directory.
...
Running this script takes about 2.5hrs on a personal Mac laptop. 
Once completed, ``Figure6_bimodal.png`` is saved under the directory.
...
Once completed, ``Figure6_unimodal.png`` is saved under the directory.
...
Running this script takes about 2.5hrs on a personal Mac laptop. 
Once completed, ``Figure6_unidentifiable.png`` is saved under the directory.
