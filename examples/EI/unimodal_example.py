...
prior_test      = 1 # prior_func(n=None, thetacnd=thetatest, thetalimits=cls_unimodal.thetalimits, seed=None, rnd=False)
...
if show:
    ...
    fig, ax = plt.subplots()    
    cp = ax.contour(Xpl, Ypl, like_test.reshape(50, 50), 20, cmap='RdGy')
