...
ax2.set_position([0.45, 0.1, 0.25, 0.8])  # Less width, more space on the left
ax3.set_position([0.75, 0.1, 0.25, 0.8])  # Normal width, more space between ax2 and ax3
...
plt.savefig("Figure_Input.jpg", format="jpeg", bbox_inches="tight", dpi=500)
plt.show()
