    ...
    for s in np.arange(args.seedmin, args.seedmax):
        ...
        dfl.extend(
            [
                ...
                for t, MAD in enumerate(al_ivar._info["TV"])
            ]
        )
        ...
        dfl.extend(
            [
                ...
                for t, MAD in enumerate(al_imse._info["TV"])
            ]
        )
        ...
        dfl.extend(
            [
                ...
                for t, MAD in enumerate(al_unif._info["TV"])
            ]
        )
        ...
        dfl.extend(
            [
                ...
                for t, MAD in enumerate(al_var._info["TV"])
            ]
        )
