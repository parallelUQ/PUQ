...
if __name__ == "__main__":
    for s in np.arange(args.seedmin, args.seedmax):
        ...
        theta = np.linspace(cls_func.thetalimits[0][0], cls_func.thetalimits[0][1], n0)[:, None]
        ...
        theta_test, nugs, phat = Figure1(f, 
                                         theta, 
                                         cls_func.x, 
                                         cls_func.obsvar, 
                                         cls_func.real_data, 
        ...
        al_ivar = designer(
            ...
            args={
                ...
                "alloc_settings":{'method':'ivar', 'use_Ki':True, 'theta':None, 'a0':None, 'gen':False, 'rho': rho},
        ...
        Figure2(al_ivar, theta_test, nugs, phat, 'ivar')
        ...
        al_imse = designer(
            ...
            args={
                ...
                "batch_size": batch,
                "des_init":{'seed':s, 'theta':theta, 'f':f},
                "alloc_settings":{'method':'imse', 'use_Ki':True, 'theta':None, 'a0':None, 'gen':False, 'rho': rho},
                "des_settings":{'is_explore':False, 'is_exploit':True},
                "pc_settings":{'standardize':True, 'latent':False},
                "trace":0,
            },
        ...
        Figure2(al_imse, theta_test, nugs, phat, 'imse')