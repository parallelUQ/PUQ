...
plot_endtime(axes[1], n, level, result, labellist=labs, worker=worker, logscale=True, fontsize=25)
plot_errorend(axes[2], n, level, result, labellist=labs, worker=worker, logscale=True, fontsize=25)
plt.show()
